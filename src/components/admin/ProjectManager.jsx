  ...
  return (
    <div className="space-y-6">
      <section className="bg-white p-6 md:p-8 rounded border border-slate-100 shadow-sm">
        ...
        {message.text && (
          <div className={`mb-6 p-3 rounded text-[11px] font-bold border ${
        ...
        <form onSubmit={handleSubmit} className="grid md:grid-cols-2 gap-4">
          ...
          <div className="md:col-span-2 space-y-1">
            ...
            <textarea 
              ...
              className="w-full px-6 py-4 bg-slate-50 border border-slate-100 rounded focus:bg-white focus:border-sky-500 outline-none transition-all text-sm font-medium h-24 resize-none"
            />
          </div>
          <div className="md:col-span-2 space-y-1.5">
            ...
            <textarea 
              ...
              className="w-full px-6 py-4 bg-slate-50 border border-slate-100 rounded focus:bg-white focus:border-sky-500 outline-none transition-all text-sm font-medium h-40 resize-none"
            />
          </div>
