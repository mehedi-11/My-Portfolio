...
import {
  Plus, Pencil, Trash2, Save, Loader2, X, Globe, Terminal, Database, Wrench,
  Smartphone, Cloud, Layout, Palette, Briefcase, Megaphone, Search, Users,
  Languages, ShieldCheck, Cpu, PenTool, HelpCircle
} from 'lucide-react';
...
const SkillManager = () => {
  ...
  const categoryIcons = {
    ...
    'devops / cloud': <Cloud size={16} />,
    'ui/ux design': <Layout size={16} />,
    'graphics design': <Palette size={16} />,
    'project management': <Briefcase size={16} />,
    'digital marketing': <Megaphone size={16} />,
    'seo optimization': <Search size={16} />,
    'soft skills': <Users size={16} />,
    language: <Languages size={16} />,
    'cyber security': <ShieldCheck size={16} />,
    'machine learning / ai': <Cpu size={16} />,
    'content writing': <PenTool size={16} />,
  ...
  async function handleSubmit(e) {
    ...
    const skillData = {
      ...
      items: typeof formData.items === 'string'
        ? formData.items.split(',').map(s => s.trim()).filter(s => s !== '')
        : formData.items
    };
    try {
      if (editingId) {
              ...
              <form onSubmit={handleSubmit} className="p-6 overflow-y-auto custom-scrollbar flex-1 space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded outline-none focus:bg-white focus:border-rose-500 text-[13px] font-medium resize-none"
                ...
                <div className="space-y-1">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded outline-none focus:bg-white focus:border-rose-500 text-[13px] font-medium resize-none"
                    placeholder="React.js, Vue.js, Tailwind CSS..."
                  />
                </div>
